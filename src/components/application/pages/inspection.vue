<template>
    <div class="concrete">
        <a-breadcrumb>
            ...
            <a-breadcrumb-item>检验检测对照管理</a-breadcrumb-item>
        </a-breadcrumb>
        <div class="buttons">
        ...
        <a-modal title="查询" v-model="visible1" @ok="reSearch">
            ...
            <div style="display:flex;align-items: center;width:80%;margin:20px auto 0;"><span>检验机构名称：</span><input style="flex:1;border:1px solid #d9d9d9;border-radius:4px;box-sizing:border-box;padding:0 11px;height:30px;line-height:30px;" type="text" v-model="show_searchData.checkCompany"></div>
        </a-modal>
    </div>
</template>
<script>
...
export default {
    ...
    methods:{
        ...
        reSearch(){
            ...
            }else if(this.show_searchData.checkCompany==''){
                this.$message.warning('请输入检测机构名称');
            }else{
                this.pageNum=1;
